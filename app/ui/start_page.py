...
from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, 
                             QListWidget, QFrame, QListWidgetItem, QSizePolicy)
...
class StartPage(QWidget):
    """
    The initial welcome screen widget, redesigned for a professional look.
    """
    ...
    def populate_recent_projects(self, project_paths):
        """
        Clears and fills the recent projects list with styled items.
        """
    ...
    def on_recent_item_clicked(self, item):
        """
        Emits a signal with the full path of the clicked recent project.
        """
